...
import { Modal, ModalOverlay, ModalBody, ModalFooter, ModalContent, ModalCloseButton, ModalHeader,    Table,
    Thead,
    Tbody,
    Tfoot,
    Tr,
...
export const Admin = () => {
    ...
    <InputGroup>
        <div>
            ...
            <Input value={first} disabled></Input>
            <Input value={last} disabled></Input>
            <Input value={email} disabled></Input>
            <Input value={desc} disabled></Input>
